...
- **Committed before review, not after.** The new Constitution (`c5f7be7`) was committed and pushed before the Product Owner had reviewed it. The Product Owner's request for a draft to review arrived after the commit had landed. On 2026-09-14 the Product Owner chose to review it where it is rather than revert it; changes from that review land as follow-up commits.
- **Reviewed and approved, 2026-09-14.** After reading the committed text, the Product Owner, verbatim: "Approved." The approval was given together with the follow-ups below.
- **Section 6 amended, 2026-09-14.** Product Owner, verbatim: "Note in §6 that the worked example is a failure and stays one until a redesign earns a pass." Section 6 now says so.
- **Frame C is now checkable.** The Study 05 frames were committed on 2026-09-14 to `docs/06-Design/studies/` (`TruLura_Study05_Home_ABC.png`, `TruLura_Study05_IdentityBeyondEffects_NoNoncanonicalMark.png`), so the note above that the repository "holds no Study 05 frames" is out of date. There is still no study record in the brief's section 5 form, and the failure verdict remains the Product Owner's report.
