...
--   exists.
--
-- The view is owner-executed so the row scope is encoded explicitly in the view
-- WHERE clause. Direct SELECT on public.posts is intentionally left unchanged
-- here; revoking it needs live testing against realtime and insert().select().
